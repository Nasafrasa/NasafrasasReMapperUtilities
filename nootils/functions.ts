    ...
    for (let i = 0; i < (duration * 6); i++) {
        ...
        wall.customData = {
            ...
            _animation: {
                ...
                _localRotation: [[Remapper.rand(0, 180), Remapper.rand(0, 180), Remapper.rand(0, 180), 0], [Remapper.rand(0, 180), Remapper.rand(0, 180), Remapper.rand(0, 180), 1]],
                _definitePosition: [[x, y, z, 0, "easeOutCubic"], [(x + Remapper.rand(-2, 2)), (y + Remapper.rand(3, 5)), z, 1]]
            }
        };
